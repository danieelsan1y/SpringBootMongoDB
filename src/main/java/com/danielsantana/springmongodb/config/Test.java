package com.danielsantana.springmongodb.config;
...
import com.danielsantana.springmongodb.dto.AuthorDTO;
import com.danielsantana.springmongodb.dto.ComentDTO;
...
public class Test implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		ComentDTO c3 = new ComentDTO("Tenha um ótimo dia!",sdf.parse("22/03/2018"),new AuthorDTO(alex));
